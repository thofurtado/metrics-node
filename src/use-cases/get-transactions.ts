...
export class GetTransactionsUseCase {
    ...
    async execute({ pageIndex, perPage, description, value, sector_id, account_id, month, status, toDate }: GetTreatmentsUseCaseRequest): Promise<GetTransactionsDTO | null> {
