...
export interface TransactionsRepository {
    ...
    findMany(month: Date, pageIndex?: number, perPage?: number, description?: string, value?: number, sector_id?: string, account_id?: string | string[], status?: string, toDate?: Date, supplier_id?: string, operation?: string, fromDate?: Date, sortBy?: string, sortDirection?: string, checked?: string): Promise<GetTransactionsDTO | null>
    findById(id: string): Promise<Transaction | null>
    delete(id: string, skipGroupUpdate?: boolean): Promise<void>
