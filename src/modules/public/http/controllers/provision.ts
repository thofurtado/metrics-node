...
export async function provisionTenant(request: FastifyRequest, reply: FastifyReply) {
    ...
    // Seguran�a b�sica: s� o master pode pedir isso (verifica��o de chave)
    ...
    // Valida��o b�sica do dbName para evitar SQL Injection
    ...
    try {
        ...
        if (dbExists.rows.length === 0) {
            ...
            console.log(`?? Banco de dados ${dbName} j� existe, ignorando cria��o.`)
        }
        await pool.end()
        ...
        // 5. Executar Onboarding Din�mico (Usu�rio Master, M�dulos selecionados, Contas, Pagamentos)
        ...
        // 6. Atualizar informa��es de schemaVersion no db_master
        try {
        ...
        console.log(`? Provisionamento e Onboarding do banco ${dbName} conclu�do com sucesso!`)
