...
var getTreatment_exports = {};
__export(getTreatment_exports, {
  getTreatment: () => getTreatment
});
module.exports = __toCommonJS(getTreatment_exports);
...
async function getTreatment(request, reply) {
  const getTreatmentsParamsSchema = import_zod2.z.object({
