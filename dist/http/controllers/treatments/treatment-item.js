...
var treatment_item_exports = {};
__export(treatment_item_exports, {
  createItemTreatment: () => createItemTreatment
});
module.exports = __toCommonJS(treatment_item_exports);
...
async function createItemTreatment(request, reply) {
  const registerBodySchema = import_zod2.z.object({
    treatment_id: import_zod2.z.string(),
    item_id: import_zod2.z.string(),
    stock_id: import_zod2.z.string().nullish(),
    quantity: import_zod2.z.number(),
    value: import_zod2.z.number(),
    discount: import_zod2.z.number().nullish()
  });
