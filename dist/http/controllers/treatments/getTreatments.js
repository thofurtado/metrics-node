...
var getTreatments_exports = {};
__export(getTreatments_exports, {
  getTreatments: () => getTreatments
});
module.exports = __toCommonJS(getTreatments_exports);
...
async function getTreatments(request, reply) {
  try {
    ...
    const getTreatmentsParamsSchema = import_zod2.z.object({
      page: import_zod2.z.coerce.string().default("1"),
      treatmentId: import_zod2.z.string().nullish(),
      clientName: import_zod2.z.string().nullish(),
