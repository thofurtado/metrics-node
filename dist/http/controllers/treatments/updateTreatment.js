...
var updateTreatment_exports = {};
__export(updateTreatment_exports, {
  updateTreatment: () => updateTreatment
});
module.exports = __toCommonJS(updateTreatment_exports);
...
async function updateTreatment(request, reply) {
  const updateTreatmentBodySchema = import_zod2.z.object({
