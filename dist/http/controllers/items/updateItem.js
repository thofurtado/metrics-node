...
var updateItem_exports = {};
__export(updateItem_exports, {
  updateItem: () => updateItem
});
module.exports = __toCommonJS(updateItem_exports);
...
async function updateItem(request, reply) {
  const updateItemParamsSchema = import_zod2.z.object({
    id: import_zod2.z.string().uuid()
  });
  const updateItemBodySchema = import_zod2.z.object({
    name: import_zod2.z.string().optional(),
    description: import_zod2.z.string().nullish(),
    cost: import_zod2.z.number().optional(),
    price: import_zod2.z.number().optional(),
    ...
    isItem: import_zod2.z.boolean().optional()
  });
