...
var getItemHistory_exports = {};
__export(getItemHistory_exports, {
  getItemHistory: () => getItemHistory
});
module.exports = __toCommonJS(getItemHistory_exports);
...
async function getItemHistory(request, reply) {
  const getItemStocksParamsSchema = import_zod2.z.object({
