...
var deleteTransaction_exports = {};
__export(deleteTransaction_exports, {
  deleteTransaction: () => deleteTransaction
});
module.exports = __toCommonJS(deleteTransaction_exports);
...
async function deleteTransaction(request, reply) {
  const deleteItemTreatmentParamsSchema = import_zod2.z.object({
