...
var deletePayment_exports = {};
__export(deletePayment_exports, {
  deletePayment: () => deletePayment
});
module.exports = __toCommonJS(deletePayment_exports);
...
async function deletePayment(request, reply) {
  const deletePaymentParamsSchema = import_zod2.z.object({
