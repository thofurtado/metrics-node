...
var updateAccount_exports = {};
__export(updateAccount_exports, {
  updateAccount: () => updateAccount
});
module.exports = __toCommonJS(updateAccount_exports);
...
async function updateAccount(request, reply) {
  const updateAccountParamsSchema = import_zod2.z.object({
    id: import_zod2.z.string().uuid()
  });
  const updateAccountBodySchema = import_zod2.z.object({
    name: import_zod2.z.string().optional(),
    description: import_zod2.z.string().nullable().optional(),
    goal: import_zod2.z.number().nullable().optional()
  });
