...
var updatePayment_exports = {};
__export(updatePayment_exports, {
  updatePayment: () => updatePayment
});
module.exports = __toCommonJS(updatePayment_exports);
...
async function updatePayment(request, reply) {
  const updatePaymentParamsSchema = import_zod2.z.object({
    id: import_zod2.z.string().uuid()
  });
  const updatePaymentBodySchema = import_zod2.z.object({
    name: import_zod2.z.string().optional(),
    installment_limit: import_zod2.z.number().optional(),
    in_sight: import_zod2.z.boolean().optional(),
