...
async function createTransaction(request, reply) {
  const registerBodySchema = import_zod2.z.object({
    ...
    account_id: import_zod2.z.string(),
    date: import_zod2.z.coerce.date().nullish(),
    sector_id: import_zod2.z.string().nullish(),
    description: import_zod2.z.string().nullish(),
    confirmed: import_zod2.z.boolean().nullish(),
    destination_account_id: import_zod2.z.string().nullish()
  });
