...
var EquipmentUseCase = class {
  constructor(equipmentRepository2, clientRepository) {
    this.equipmentRepository = equipmentRepository2;
...
// src/use-cases/equipment.spec.ts
var clientsRepository;
var equipmentRepository;
var equipmentUseCase;
describe("Equipment Use Case", () => {
  ...
  it("should be able to create a equipment", async () => {
    ...
    globalExpect(equipment.id).toEqual(globalExpect.any(String));
  });
  it("should not be able to create a equipment without a valid client", async () => {
    await globalExpect(
      equipmentUseCase.execute({
        client_id: "client.id",
        type: "Computador",
        entry: /* @__PURE__ */ new Date()
      })
