...
var GetTreatmentsUseCase = class {
  constructor(treatmentsRepository2) {
...
// src/use-cases/get-treatments.spec.ts
var treatmentsRepository;
var getTreatmentsUseCase;
describe("Get Treatments Use Case", () => {
  ...
  it("should be able to get treatments", async () => {
    await treatmentsRepository.create({
      request: "solicita\xE7\xE3o 1"
    });
    await treatmentsRepository.create({
      request: "solicita\xE7\xE3o 2"
    });
    await treatmentsRepository.create({
      request: "solicita\xE7\xE3o 3",
      status: "resolved"
    });
    await treatmentsRepository.create({
      request: "solicita\xE7\xE3o 4",
      status: "resolved"
    });
    await treatmentsRepository.create({
      request: "solicita\xE7\xE3o 5",
      status: "in_progress"
    });
    const treatments = await getTreatmentsUseCase.execute();
    console.log("Treatments Lenght: " + treatments.treatments?.length);
    globalExpect(treatments.treatments?.length).toEqual(3);
  });
});
