...
// src/use-cases/delete-transaction.spec.ts
...
describe("Delete Transaction Use Case", () => {
  ...
  it("should be able to delete a non-confirmed transaction", async () => {
    ...
    globalExpect(deletedTransaction).toBeNull();
  });
  it("should not be able to delete a confirmed transaction", async () => {
    ...
    await globalExpect(sut.execute({ id: transaction.id })).rejects.toBeInstanceOf(TransactionAlreadyConfirmedError);
  });
  it("should not be able to delete a non-existent transaction", async () => {
    await globalExpect(sut.execute({ id: "non-existent-id" })).rejects.toBeInstanceOf(ResourceNotFoundError);
  });
});
