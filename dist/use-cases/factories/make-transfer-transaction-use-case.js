...
// src/use-cases/factories/make-transfer-transaction-use-case.ts
var make_transfer_transaction_use_case_exports = {};
__export(make_transfer_transaction_use_case_exports, {
  makeTransferTransactionuseCase: () => makeTransferTransactionuseCase
});
module.exports = __toCommonJS(make_transfer_transaction_use_case_exports);
...
// src/use-cases/factories/make-transfer-transaction-use-case.ts
function makeTransferTransactionuseCase() {
...
0 && (module.exports = {
  makeTransferTransactionuseCase
});
