...
var TreatmentItemUseCase = class {
  constructor(treatmentItemsRepository2, treatmentsRepository2, itemsRepository2, stocksRepository2) {
    this.treatmentItemsRepository = treatmentItemsRepository2;
    this.treatmentsRepository = treatmentsRepository2;
    this.itemsRepository = itemsRepository2;
    this.stocksRepository = stocksRepository2;
  }
  async execute({
    item_id,
    treatment_id,
...
// src/use-cases/treatmentItem.spec.ts
var treatmentItemsRepository;
var itemsRepository;
var treatmentsRepository;
var stocksRepository;
var treatmentItemUseCase;
describe("TreatmentItem Use Case", () => {
  ...
  it("should be able to create treatmentItem", async () => {
    ...
    globalExpect(treatmentItem.id).toEqual(globalExpect.any(String));
  });
  it("should not be able to create a treatmentItem with an invalid treatment", async () => {
    ...
    await globalExpect(treatmentItemUseCase.execute({
      item_id: item.id,
      treatment_id: "treatment.id",
      quantity: 5,
      salesValue: 10
  ...
  it("should not be able to create a treatmentItem with an invalid stock", async () => {
    ...
    globalExpect(treatmentItem.treatmentItem.id).toEqual(globalExpect.any(String));
  });
