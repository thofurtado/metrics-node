...
var GetTransferTransactionsUseCase = class {
  constructor(transferTransactionsRepository2) {
...
// src/use-cases/get-transfer-transactions.spec.ts
var transferTransactionsRepository;
var getTransferTransactionsUseCase;
...
describe("Get TransferTransactions Use Case", () => {
  ...
  it("should be able to get transferTransactions", async () => {
    ...
    globalExpect(transferTransactions.transferTransactions?.length).toEqual(3);
  });
});
