...
var InteractionUseCase = class {
  constructor(interactionsRepository2, usersRepository2, treatmentsRepository2) {
...
// src/use-cases/interaction.spec.ts
var interactionsRepository;
var usersRepository;
var treatmentsRepository;
var interactionUseCase;
describe("Interaction Use Case", () => {
  ...
  it("should be able to create an interaction", async () => {
    ...
    const { interaction } = await interactionUseCase.execute({
      ...
      description: "Usu\xE1rio n\xE3o estava disponivel",
      date: /* @__PURE__ */ new Date("11/02/2024 05:30:00")
    });
    globalExpect(interaction.id).toEqual(globalExpect.any(String));
  });
  it("should be able to create an interaction with a invalid treatment id", async () => {
    ...
    await globalExpect(interactionUseCase.execute({
      user_id: user.id,
      treatment_id: "treatment.id",
      description: "Usu\xE1rio n\xE3o estava disponivel",
      date: /* @__PURE__ */ new Date("11/02/2024 05:30:00")
