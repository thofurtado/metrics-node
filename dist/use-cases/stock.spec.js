...
var StockUseCase = class {
  constructor(stocksRepository2, itemsRepository2) {
...
describe("Stock Use Case", () => {
  ...
  it("should be able to create a stock", async () => {
    ...
    globalExpect(stock.id).toEqual(globalExpect.any(String));
  });
  ...
  it("should not be able to create a stock with inexistent item", async () => {
    await globalExpect(stockUseCase.execute({
      item_id: "item.id",
      quantity: 5,
      operation: "input"
