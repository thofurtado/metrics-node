...
var TransactionUseCase = class {
  constructor(transactionsRepository2, transferTransactionsRepository2, accountsRepository2) {
    this.transactionsRepository = transactionsRepository2;
    this.transferTransactionsRepository = transferTransactionsRepository2;
...
// src/use-cases/transaction.spec.ts
var transactionsRepository;
var accountsRepository;
var transferTransactionsRepository;
...
describe("Transaction Use Case", () => {
  ...
  it("should be able to create transaction", async () => {
    ...
    globalExpect(transaction.id).toEqual(globalExpect.any(String));
  });
  ...
  it("should not be able to create transaction with a invalid account", async () => {
    await globalExpect(transactionUseCase.execute({
      operation: "income",
      amount: 50,
      account_id: "account.id",
      date: /* @__PURE__ */ new Date(),
  ...
  it("should not be able change account balance if transition its not confirmed", async () => {
    ...
    globalExpect(conta1).toHaveProperty("balance", 100);
    globalExpect(conta2).toHaveProperty("balance", 30);
  });
  it("should be able to create a transfer transaction register when operation is transfer and alter balance in account", async () => {
    ...
    globalExpect(conta1).toHaveProperty("balance", 50);
    globalExpect(conta2).toHaveProperty("balance", 250);
    globalExpect(transaction.transaction.id).toEqual(globalExpect.any(String));
  });
