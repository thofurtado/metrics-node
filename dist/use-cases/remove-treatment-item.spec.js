...
var RemoveTreatmentItemUseCase = class {
  constructor(treatmentItemsRepository2, treatmentsRepository2) {
...
// src/use-cases/remove-treatment-item.spec.ts
var treatmentItemsRepository;
var removeTreatmentItemUseCase;
...
describe("Remove Treatment Item Use Case", () => {
  ...
  it("should not be able to create a treatmentItem with a invalid id", async () => {
    await globalExpect(removeTreatmentItemUseCase.execute({
      id: "false_id"
