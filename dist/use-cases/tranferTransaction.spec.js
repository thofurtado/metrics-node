...
var TransferTransactionUseCase = class {
  constructor(transferTransactionssRepository, transactionsRepository2, accountsRepository2) {
...
var InMemoryTransactionsRepository = class {
  ...
  async create(data) {
    const transaction = {
      id: data.id ? data.id : (0, import_node_crypto3.randomUUID)(),
...
// src/use-cases/tranferTransaction.spec.ts
var transferTransactionsRepository;
var accountsRepository;
var transactionsRepository;
var transferTransactionUseCase;
describe("Treatment Use Case", () => {
  ...
  it("should be able to create transferTransaction", async () => {
    ...
    globalExpect(transferTransaction.transferTransactions.id).toEqual(globalExpect.any(String));
  });
  it("should not be able to create transferTransaction with an invalid account", async () => {
    ...
    globalExpect(transferTransactionUseCase.execute({
      destination_account_id: "account.id",
      transaction_id: transaction.id
