...
var PaymentEntryUseCase = class {
  constructor(paymentEntrysRepository2, paymentRepository, treatmentRepository) {
...
describe("PaymentEntry Use Case", () => {
  ...
  it("should be able to create an paymentEntry", async () => {
    ...
    globalExpect(paymentEntry.id).toEqual(globalExpect.any(String));
  });
  it("should not be able to create an paymentEntry with a invalid payment", async () => {
    ...
    await globalExpect(paymentEntryUseCase.execute({
      payment_id: "payment.id",
      treatment_id: treatment.id,
      occurrences: 1,
      amount: 100
