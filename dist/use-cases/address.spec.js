...
var AddressUseCase = class {
  constructor(addressRepository2, clientsRepository2) {
...
describe("Address Use Case", () => {
  ...
  it("should be able to create a address", async () => {
    ...
    const { address } = await addressUseCase.execute({
      ...
      number: 180,
      neighborhood: "Capric\xF3rnio II",
      city: "Caraguatatuba",
      state: "SP",
      zipcode: 11676405,
      client_id: client.id
    });
    globalExpect(address.id).toEqual(globalExpect.any(String));
  });
  it("should not be able to create a address without a client", async () => {
    await globalExpect(addressUseCase.execute({
      street: "Rua Tatsuo Matsumoto",
      number: 180,
      neighborhood: "Capric\xF3rnio II",
      city: "Caraguatatuba",
